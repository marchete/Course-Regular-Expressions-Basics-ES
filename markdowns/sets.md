...
@[Exercise 1 - Searching 'ain' character set]({"layout": "aside","stubs": ["Exercises/Exercise1.cs"],"command": "RegexCourse.Validator.VerifyExercise1"})
...
@[Exercise 3 - Searching years 2000 to 2199 ]({"layout": "aside","stubs": ["Exercises/Exercise3.cs"],"command": "RegexCourse.Validator.VerifyExercise3"})