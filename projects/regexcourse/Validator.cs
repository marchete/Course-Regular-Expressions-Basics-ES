...
@"namespace RegexCourse{
    public static class Exercise2{
        ...
        public static string Pattern_Exercise2=@""\b2[01]\d\d\b"";
            ...
            File.WriteAllText (Path.Combine(ReportPath,"sol_ex2.txt"),"<pre><code class=\"language-csharp\">"+WebUtility.HtmlEncode(sol)+"</code></pre>");
...
@"namespace RegexCourse{
    public static class Exercise3{
        ...
        public static string Pattern_Exercise3=@""[A-Za-z-[AEIOUaeiou]][aeiou][ns]"";
            ...
            File.WriteAllText (Path.Combine(ReportPath,"sol_ex3.txt"),"<pre><code class=\"language-csharp\">"+WebUtility.HtmlEncode(sol)+"</code></pre>");
...
@"namespace RegexCourse{
    public static class Exercise4{
        ...
        public static string Pattern_Exercise4=@""<\/?[a-zA-Z0-9=\s\-""""_:]+?>"";
            ...
            File.WriteAllText (Path.Combine(ReportPath,"sol_ex4.txt"),"<pre><code class=\"language-csharp\">"+WebUtility.HtmlEncode(sol)+"</code></pre>");
...
@"namespace RegexCourse{
    public static class Exercise5{
        ...
        public static string Pattern_Exercise5=@""[\w\.+_\-=\(\)]+\.([jJ][pP][eE]?[gG]|[gG][Ii][Ff]|[pP][nN][Gg]|[bB][mM][Pp])"";
            ...
            File.WriteAllText (Path.Combine(ReportPath,"sol_ex5.txt"),"<pre><code class=\"language-csharp\">"+WebUtility.HtmlEncode(sol)+"</code></pre>");
...
@"namespace RegexCourse{
    public static class Exercise6{
		...
		//public static string Pattern_Exercise6=@"""";
            ...
            File.WriteAllText (Path.Combine(ReportPath,"sol_ex6.txt"),"<pre><code class=\"language-csharp\">"+WebUtility.HtmlEncode(sol)+"</code></pre>");
        ...
        public void VerifyExample1()
        {
			...
			File.WriteAllText (Path.Combine(ReportPath,"sol_example1.txt"),"<pre><code class=\"language-csharp\">"+WebUtility.HtmlEncode(sol)+"</code></pre>");
        ...
        public void VerifyExample2()
        {
            string hints = "On this button you'll get hints for solving each exercise.";
			string sol = @"You'll see the solutions for each exercise here";
			File.WriteAllText (Path.Combine(ReportPath,"sol_example2.txt"),"<pre><code class=\"language-csharp\">"+WebUtility.HtmlEncode(sol)+"</code></pre>");
